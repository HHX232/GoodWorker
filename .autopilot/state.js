window.STATE =
{
  ...
  "updatedAt": "2026-09-16T18:45:00+03:00",
  "finishedAt": null,
  "tier": "T2",
  "stages": [
    ...
    { "id": "build",     "status": "active",  "startedAt": "2026-09-16T00:12:00+03:00", "note": "6 из 7 тасков готовы; последний — 05 (карточки событий)" },
    { "id": "review",    "status": "pending" },
    { "id": "final",     "status": "pending" }
  ],
  "requirements": { "total": 30, "done": 27, "inTicket": 3, "inSpec": 0, "placeholder": 0, "deferred": 0, "dropped": 0 },
  "tickets": [
    ...
    { "id": "04", "title": "Вложения: фото/файлы, сжатие, ГС", "requirements": ["R11", "R11.1", "R11.2", "R12", "R12.1", "R16", "R16.1"], "blockedBy": ["03"], "wave": 4, "zone": ["src/widgets/Chat/ConversationView/", "src/shared/helpers/compressImageForUpload.ts"], "status": "done", "startedAt": "2026-09-16T12:10:00+03:00", "finishedAt": "2026-09-16T14:20:00+03:00", "retries": 1, "repairs": 0, "commit": "0b75e04", "files": ["src/widgets/Chat/ConversationView/ConversationView.tsx", "src/widgets/Chat/ConversationView/ConversationView.module.scss", "src/widgets/Chat/MessageBubble/MessageBubble.tsx", "src/widgets/Chat/MessageBubble/MessageBubble.module.scss", "src/shared/helpers/compressImageForUpload.ts"], "concerns": ["craft: ещё 3 дублированных SVG-иконки поверх уже установленной lucide-react — эскалировано в новый тикет T07 (D02), не чинилось внутри T04"] },
    { "id": "07", "title": "Общие иконки чата (D02, устранение дублей)", "requirements": ["D02"], "blockedBy": ["04"], "wave": 5, "zone": ["src/widgets/Chat/icons.tsx", "src/widgets/Chat/ChatShell/", "src/widgets/Chat/ConversationList/", "src/widgets/Chat/ConversationView/", "src/widgets/Chat/MessageBubble/", "src/widgets/BaseUI/Header/ChatHeaderIcon.tsx", "src/widgets/Dashboard/DashboardCenter/", "src/widgets/Dashboard/StudentDetailModal/"], "status": "done", "startedAt": "2026-09-16T14:25:00+03:00", "finishedAt": "2026-09-16T18:40:00+03:00", "retries": 0, "repairs": 0, "commit": "e756489", "files": ["src/widgets/Chat/icons.tsx", "src/widgets/Chat/ChatShell/ChatShell.tsx", "src/widgets/Chat/ConversationList/ConversationList.tsx", "src/widgets/Chat/ConversationView/ConversationView.tsx", "src/widgets/Chat/MessageBubble/MessageBubble.tsx", "src/widgets/BaseUI/Header/ChatHeaderIcon.tsx", "src/widgets/Dashboard/DashboardCenter/DashboardCenter.tsx", "src/widgets/Dashboard/StudentDetailModal/StudentDetailModal.tsx"], "concerns": [] },
    { "id": "05", "title": "Карточки событий: ДЗ, услуга, оплата", "requirements": ["R13", "R14", "R15"], "blockedBy": ["07"], "wave": 6, "zone": ["src/widgets/Chat/MessageBubble/", "app/api/homework/route.ts", "app/api/services/route.ts", "tg-bot/src/scheduler.ts", "tg-bot/src/db.ts"], "status": "in-progress", "startedAt": "2026-09-16T18:45:00+03:00", "retries": 0, "repairs": 0 },
  ...
  "debt": { "placeholders": [], "assumptions": [], "emptyEnv": [], "craftNotes": ["иконки чата — эскалировано из заметки в полноценный тикет T07 (D02), запускается перед T05", "паттерн поллинг+бейдж скопирован из NotificationBell в ChatHeaderIcon почти 1:1 — кандидат на общий хук usePolledBadge(url, intervalMs) — оставлено как есть, не структурная проблема"] },
  "additions": [],
