window.STATE =
{
  ...
  "updatedAt": "2026-09-16T13:00:00+03:00",
  "finishedAt": null,
  "tier": "T2",
  "stages": [
    ...
    { "id": "build",     "status": "active",  "startedAt": "2026-09-16T00:12:00+03:00", "note": "04 закоммичен, ждёт ревью — оба ревьюера упали по лимиту сессии (сброс ~15:30 Europe/Minsk), не по содержанию" },
  ...
  "tickets": [
    ...
    { "id": "04", "title": "Вложения: фото/файлы, сжатие, ГС", "requirements": ["R11", "R11.1", "R11.2", "R12", "R12.1", "R16", "R16.1"], "blockedBy": ["03"], "wave": 4, "zone": ["src/widgets/Chat/ConversationView/", "src/shared/helpers/compressImageForUpload.ts"], "status": "review", "startedAt": "2026-09-16T12:10:00+03:00", "retries": 1, "repairs": 0, "commit": "0b75e04", "files": ["src/widgets/Chat/ConversationView/ConversationView.tsx", "src/widgets/Chat/ConversationView/ConversationView.module.scss", "src/widgets/Chat/MessageBubble/MessageBubble.tsx", "src/widgets/Chat/MessageBubble/MessageBubble.module.scss", "src/shared/helpers/compressImageForUpload.ts"], "concerns": ["код закоммичен и запушен; ревью (manifest+spec и craft) не завершилось — оба ревьюера упали по лимиту сессии/аутентификации, не по содержанию кода — ждём сброса лимита (~15:30 Europe/Minsk) и повторного запуска ревью"] },
    { "id": "05", "title": "Карточки событий: ДЗ, услуга, оплата", "requirements": ["R13", "R14", "R15"], "blockedBy": ["04"], "wave": 5, "zone": ["src/widgets/Chat/MessageBubble/", "app/api/homework/route.ts", "app/api/services/route.ts", "tg-bot/src/scheduler.ts", "tg-bot/src/db.ts"], "status": "pending", "retries": 0, "repairs": 0 },
