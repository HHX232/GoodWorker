...
const RoadmapService = {
  ...
  async update(
    id: string,
    dto: { title?: string; content?: unknown; price?: number; previewImageUrl?: string | null; nodeAccessType?: RoadmapNodeAccessType | null; currency?: string; categoryIds?: string[] }
  ): Promise<IRoadmapItem> {
    try {
