    ...
    try {
      ...
      try {
        const res = await fetch('/api/call/rooms', {
          ...
          body: JSON.stringify({roomName: name, ...params}),
        })
    ...
    <>
      <div className={styles.wrapper}>
        ...
        <div className={styles.joinPane}>
          ...
          <button className={styles.joinBtn} onClick={openModal} disabled={!roomName.trim() || loading}>
            {loading ? (
              <span
                style={{
                  width: 16,
      ...
      <CreateRoomModal
        isOpen={modalOpen}
        onClose={() => setModalOpen(false) as any}
