...
function FreeAnswerEditor({ blockId, payload, readonly = false }: Props) {
  ...
  return (
    <div className={styles.editor_box}>
      ...
      <div className={styles.field}>
        <span className={styles.label}>Эталонный ответ <span className={styles.hint}>(для проверки ИИ)</span></span>
        <TextAreaUI
          minRows={2}
