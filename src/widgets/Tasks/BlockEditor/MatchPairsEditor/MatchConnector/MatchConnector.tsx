...
import styles from './MatchConnector.module.scss'
          ...
          return (
            ...
            >
              ...
              <div
                ...
                className={`${styles.handle} ${styles.handle_right} ${connected ? styles.handle_connected : ''} ${
                  active ? styles.handle_active : ''
                }`}
          ...
          return (
            ...
            >
              <div
                ...
                className={`${styles.handle} ${styles.handle_left} ${connected ? styles.handle_connected : ''} ${
                  active ? styles.handle_active : ''
                }`}
