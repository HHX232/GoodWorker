...
export function PostCommentModal({isOpen, onClose, comments, totalComments, scrollToCommentId}: PostCommentModalProps) {
  ...
  return (
    ...
    >
      <ul className={styles.comments_list}>
        {comments.map((el, i) => (
          <div className={styles.comment_item} key={`${el.user.userID}-${i}`} id={el.user.userID}>
